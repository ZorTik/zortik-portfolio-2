...
import {TOKEN_COOKIE_NAME, TOKEN_EXP_COOKIE_NAME, USER_COOKIE_NAME, USER_NAME_COOKIE_NAME} from "@/data/constants";
...
export default async function handler(
    ...
    setHeader('Set-Cookie', [
        ...
        `${TOKEN_EXP_COOKIE_NAME}=; HttpOnly; Path=/; Max-Age=0`,
    ]);
